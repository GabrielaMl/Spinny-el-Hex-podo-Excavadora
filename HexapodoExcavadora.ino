...
void pararse(){
  ...
  Serial.println("#2 P1800 T300");//c


  //PATA 2
  Serial.println("#4 P2000 T300");//a
  Serial.println("#5 P2300 T300");//b
  Serial.println("#6 P1500 T300");//c

  //PATA 1
  Serial.println("#8 P2000 T300");//a
  Serial.println("#9 P1900 T300");//b
  Serial.println("#10 P1100 T300");//c
  ...
  Serial.println("#18 P1900 T300");//c

  //PATA 5
  Serial.println("#20 P1000 T300");//a
  Serial.println("#21 P1050 T300");//b
  Serial.println("#22 P1500 T300");//c

  //PATA 4
  Serial.println("#24 P1000 T300");//a
  Serial.println("#25 P1100 T300");//b
  Serial.println("#26 P1200 T300");//c
}
